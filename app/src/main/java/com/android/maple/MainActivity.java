...
import com.android.maple.ui.UIDialogComponent;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UIDialogComponent dialogComponent = new UIDialogComponent(this);

      initCustomView(dialogComponent);
      setContentView(dialogComponent);
    }

    private void initCustomView(UIDialogComponent customView) {
