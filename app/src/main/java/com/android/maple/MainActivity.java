...
import com.android.maple.ui.UIDialogRecyclerView;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UIDialogRecyclerView dialogComponent = new UIDialogRecyclerView(this);

      initCustomView(dialogComponent);
      setContentView(dialogComponent);
    }

    private void initCustomView(UIDialogRecyclerView customView) {
